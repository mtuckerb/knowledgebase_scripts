...
module.exports = async function(app, tp, directoryPath) {
  ...
  await tp.file.move(`${directoryPath}/${course}/${textShort}/Chapter ${chapterNumber}/${textShort} - Chapter ${chapterNumber} - Notes.md`)
  try {await app.vault.createFolder(`${directoryPath}/${course}/${textShort}/Chapter ${chapterNumber}/Attachments`)} catch (e) {}
